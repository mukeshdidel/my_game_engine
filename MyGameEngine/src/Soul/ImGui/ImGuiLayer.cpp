...
#define SOUL_BIND_EVENT_FN(x) std::bind(&x, this, std::placeholders::_1)
	...
	void ImGuiLayer::OnAttach()
	{
		...
		io.BackendFlags |= ImGuiBackendFlags_HasSetMousePos;  // We can honor io.WantSetMousePos requests (optional, rarely used) see SetMousePos() function. This is only used if the imgui config flag ImGuiConfigFlags_NavEnableSetMousePos is set.
		...
		//
		//GLFWwindow* window = (GLFWwindow*)Application::Get()
		//	.GetWindow()
		//	.GetNativeWindow();
